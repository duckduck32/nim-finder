...
<body style="background-color: #e5e5e5;">
    ...
    <div id="container" class="border border-primary;p-3 mb-2 bg-white text-dark; w-50 p-3" style="margin-top: 25vh; margin-left: 50vh">
            ...
            <h4>Masukkan format NIM yang valid [10 angka NIM]</h4>
            <br>
            <a href="./homepage.php"><button class="btn btn-secondary btn-block btn-ghost" name="back" value="back">Back</button></a>
    </div>
